...
menu_manager::menu_manager(menu_bar *menubar)
    ...
    auto file_menu_open = new QAction("Open", this);
    auto file_menu_open_dir = new QAction("Open directory", this);
    auto file_menu_close = new QAction("Close", this);
    auto file_menu_close_all = new QAction("Close All", this);
    auto file_menu_quit = new QAction("Quit", this);
    auto property_export = new QAction("Export", this);
    auto help_menu_about_qt = new QAction("About Qt", this);
    auto view_menu_word_wrap = new QAction("Word Wrap", this);
    auto window_menu_full_screen = new QAction("Full screen", this);
